                        ...
                        <div>
                            ...
                            <div>
                                <DatePicker
                                    ...
                                    value={data.from}
                                    onChange={(from) => {
                                        // Format the selected from as 'YYYY-MM-DD' before updating the state
                                        setData('from', from ? format(from, 'yyyy-MM-dd') : '');
                                    }}
                                    className="px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <div>
                                <DatePicker
                                    ...
                                    value={data.to}
                                    onChange={(to) => {
                                        // Format the selected to as 'YYYY-MM-DD' before updating the state
